...
import { userSignup, login, logout, getCurrentUser, updateUserProfile, forgotpassword, resetPassword, resetpasswordui, followUser, followers, getAllUsers, searchUsers, deleteAccount, searchUserByid } from '../controller/user.controller.js'
router.route("/")
