...
const likePost = async (req, res) => {
    try {
        ...
        await post.save();
        return res.status(200).json({ message: "Post liked/unliked successfully", postlikes: post.likes });
    } catch (error) {
...
export { uploadPost, getAllPost, getpost, updatePost, deletePost, likePost, addComment, deleteComment, updateComment, getAllComment, postToshow, searchByTitle, savePost, allsavedPost };
